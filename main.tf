...
resource "aws_internet_gateway" "this" {
  count = var.create_vpc && var.create_igw && length(var.public_subnets) > 0 || length(var.public_eks_subnets) > 0 || length(var.public_eks_subnets_green) > 0 ? 1 : 0
...
resource "aws_route_table" "public" {
  count = var.create_vpc && length(var.public_subnets) > 0 || length(var.public_eks_subnets) > 0 || length(var.public_eks_subnets_green) > 0 ? 1 : 0
...
resource "aws_route" "public_internet_gateway_ipv6" {
  count = var.create_vpc && var.create_igw && var.enable_ipv6 && length(var.public_subnets) > 0 || length(var.public_eks_subnets) > 0 || length(var.public_eks_subnets_green) > 0 ? 1 : 0
